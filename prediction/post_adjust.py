...
_LEAGUE_HIT_PENALTIES = {
    ...
    '挪超': (0.455, 1.00, 0.50),
    '德乙': (0.500, 1.05, 0.50),
    '解放者杯': (0.000, 0.00, 0.20),   # P2修复(2026-05-14): 0/7命中→暂停预测，仅娱乐参考
    'Copa Libertadores': (0.000, 0.00, 0.20),
    '澳超': (0.500, 1.00, 0.50),
    '英超': (0.333, 0.75, 0.45),  # 报告降权 (33.3%)
    'English Premier League': (0.422, 0.95, 0.50),
    '德甲': (0.371, 0.90, 0.50),
    'German Bundesliga': (0.371, 0.90, 0.50),
    '意甲': (0.125, 0.45, 0.35),  # 报告降权 (12.5%)
    ...
    '日职': (0.143, 0.45, 0.35),  # 报告降权 (14.3%)
    'J1 League': (0.000, 0.00, 0.20),  # 报告降权 (J联赛0%,4场)
    '韩职': (0.250, 0.65, 0.40),  # 报告降权 (25.0%)
    'K League 1': (0.367, 0.85, 0.45),
    '沙职': (0.286, 0.65, 0.40),  # 报告降权 (28.6%)
    '沙特联': (0.434, 0.90, 0.45),
    '美职': (0.250, 0.70, 0.40),
    'MLS': (0.250, 0.70, 0.40),
    '瑞超': (0.278, 0.70, 0.40),
    'Swiss Super League': (0.278, 0.70, 0.40),
    '英冠': (0.250, 0.55, 0.25),   # P2修复(2026-05-14): 25.0%(24场)→降至0.55系数+0.25上限
    'English Championship': (0.250, 0.55, 0.25),
    '法乙': (0.154, 0.40, 0.20),   # P2修复(2026-05-14): 15.4%(13场)→降至0.40系数+0.20上限(近乎暂停)
    'Ligue 2': (0.154, 0.40, 0.20),
    'J联赛': (0.000, 0.00, 0.20),   # P2修复(2026-05-14): 0%(4场)→暂停预测
    'J1 League': (0.000, 0.00, 0.20),
    'Copa Libertadores': (0.000, 0.00, 0.20),
